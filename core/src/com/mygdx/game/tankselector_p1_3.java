...
public class tankselector_p1_3 implements Screen {
    private MyGdxGame game;
    private Stage stage;
    private Texture tex1;


    public tankselector_p1_3(MyGdxGame ga){
        this.game=ga;
    ...
    public Texture tank3 = new Texture("tank3.png");
    ...
    public void show() {
        ...
        left.addListener(new ClickListener(){
            ...
            public void clicked(InputEvent event, float x, float y) {
                game.setScreen(new tankselector_p1_2(game));
            }
        });
    ...
    public void render(float delta) {
        ...
        game.batch.draw(tank3,-50,28,700,400);
        game.batch.end();
