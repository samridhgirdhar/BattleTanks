...
public class tankselector_p1_2 implements Screen {
    private MyGdxGame game;
    private Stage stage;
    private Texture tex1;


    public tankselector_p1_2(MyGdxGame ga){
        this.game=ga;
    ...
    public Texture tank2 = new Texture("tank2.png");
    ...
    public void show() {
        ...
        right.addListener(new ClickListener(){
            @Override
            public void clicked(InputEvent event, float x, float y) {
                game.setScreen(new tankselector_p1_3(game));
            }
        });
        ...
        select.addListener(new ClickListener(){
            @Override
            public void clicked(InputEvent event, float x, float y) {
                game.setScreen(new tankselector_p2_1(game));
            }
        });
    ...
    public void render(float delta) {
        ...
        game.batch.draw(tank2,-100,28,700,400);
        game.batch.end();
